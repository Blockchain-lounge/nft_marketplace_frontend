...
export { default as Eyecoin } from "./eye-icon";
...
export { default as SupportBuyIcon } from "./support-buy-icon";
export { default as SupportFaqIcon } from "./support-faq-icon";
export { default as SupportGettingStartedIcon } from "./support-getting-started-icon";
export { default as SupportListingIcon } from "./support-list-icon";
export { default as SupportSellIcon } from "./support-sell-icon";
