  ...
  const handleEndAuction = async () => {
    ...
    if (itemDetail.listing_type === "auction") {
      ...
      try {
        ...
        const transaction = await contract.finishAuction(tokenId, {
        ...
        alert(
          "Unable to close this Auction. Please ensure that this auction have ended."
        );
      ...
      if (itemDetail.listing_type === "fixed") {
        if (
          ...
          try {
            ...
            setIsTransLoading((prev) => !prev);
            alert(
              "Unable to cancel this Auction. Please ensure that this auction does not have bids yet."
            );
            toast("Transaction cancelled!");
            return;
          }
                        ...
                        {dollarRate ? (
                          <span className="flex items-center text-xl mt-2">
                            ...
                            {(itemDetail.listing_type === "auction"
                              ...
                              : itemDetail.listing_type === "fixed"
                              ? itemDetail.listing_price * dollarRate
                              : 0.0
                            ).toFixed(2)}
                          </span>
                        ) : (
                    ...
                    {itemDetail.listing_type === "fixed" ? (
                      <>
                        ...
                        <Button
                          ...
                          wt="w-full"
                          isDisabled={isTransloading && cancelType === "cancel"}
